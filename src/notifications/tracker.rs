...
/// Tracks PR state between poll cycles to detect changes worth notifying about
...
impl ChangeTracker {
    ...
    /// Compare new PR list against previous state and return changes
...
fn pr_key(id: &PrId) -> String {
    format!("{}:{}:{}:{}", id.provider, id.project, id.repository, id.number)
}
